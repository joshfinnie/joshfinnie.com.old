...
p. I have recently been testing out "Sublime Text 2":http://www.sublimetext.com/2 and have to say that I am liking what I am seeing.  Sublime seems to just give me a little more than I have with MacVIM allowing me to write code just that much faster. I am still hoping for a VIM key binding plug-in for Sublime; once that comes I will probably use Sublime for life.

p. Other programs I use on a regular basis are:

* "Spotify":http://www.spotify.com & "Grooveshark":http://grooveshark.com for music
* "Filezilla":http://filezilla-project.org/ for FTP
* "QGIS":http://qgis.org for a awesome open source GIS suite
* "Pixelmator":http://www.pixelmator.com/ for image manipulation
